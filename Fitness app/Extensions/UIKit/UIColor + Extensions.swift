...
// extension для UIColor вызывать только цвета которые нужны в приложении
extension UIColor {
    
    static let specialBackground = #colorLiteral(red: 0.9411764706, green: 0.9294117647, blue: 0.8862745098, alpha: 1) // #colorLiteral()
